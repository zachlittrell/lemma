...
%penguinstack morphology 
\newcommand{\penguin}[1]{
  \pic{width=#1}{images/tux.png}
}
\newcommand{\babypenguin}{\penguin{10pt}}
\newcommand{\kidpenguin}{\penguin{25pt}}
\newcommand{\adultpenguin}{\penguin{50pt}}
\newcommand{\greatpenguin}{\penguin{60pt}}
...
%Defining penguin stacks as a lattice
...
%Observing the supremum of a penguin stack
...
%Observing the infimum of a penguin stack
...
%Defining penguin stack erosion 
\begin{frame}{$\erode$ Erosion}
  \begin{definition}
...
%Applying Penguin Morphology
%%\begin{frame}{Applications of Penguin Morphology:}
%%  Want to know if your penguin stack has a multiple of  
%%\end{frame}
