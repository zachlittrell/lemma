...
\begin{frame}{Formally looking at $\integers^2$}
  As our original morphological tools operate on integer coordinates,
  it'd be nice to figure out whether it can be trusted
...
\begin{block}{Theorem}
  Let $C$ be a closed, polygonal path in $\mathbb{R}^2$.\\
